...
namespace TMRC_CSP.ViewModel.PartnerRepository
{
    public class PortalLocalization : DomainObject
    {
        ...
        {
            var partnerLegalBusinessProfile = await ApplicationDomain.PartnerCenterClient.Profiles.LegalBusinessProfile.GetAsync().ConfigureAwait(false);
